...
function _createMdxContent(props) {
  ...
  return _jsxs(LearnLayout, {
    children: [_jsx(_components.h1, {
    ...
    }), _jsx(TaskScheduling, {}), _jsx(_components.h3, {
      id: "原理",
      children: _jsx(_components.a, {
        href: "#原理",
        children: "原理"
      ...
      children: ["✓ ", _jsx(_components.strong, {
        children: "负载均衡"
      }), "：自动平衡各线程任务✓ ", _jsx(_components.strong, {
        children: "缓存友好"
      ...
      children: _jsx(_components.code, {
        className: "language-rust",
        children: "tokio::task::spawn_blocking(|| {\n    // CPU 密集或阻塞操作\n    expensive_computation()\n});\n"
      })
    }), _jsxs(_components.p, {
      children: [_jsx(_components.strong, {
        children: "区别"
      ...
      children: _jsx(_components.code, {
        className: "language-rust",
        children: "async fn cooperative_task() {\n    for i in 0..1000 {\n        // 执行工作\n        do_work(i);\n\n        // 每 100 次迭代让出一次\n        if i % 100 == 0 {\n            tokio::task::yield_now().await;\n        }\n    }\n}\n"
      })
    }), _jsx(_components.h2, {
      id: "小结",
      children: _jsx(_components.a, {
