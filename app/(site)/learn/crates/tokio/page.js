...
function _createMdxContent(props) {
  ...
  return _jsxs(LearnLayout, {
    children: [_jsx(_components.h1, {
    ...
    }), _jsx(RuntimeVisualization, {}), _jsx(_components.h3, {
      id: "多线程运行时",
      children: _jsx(_components.a, {
        href: "#多线程运行时",
        children: "多线程运行时"
      ...
      children: _jsx(_components.code, {
        ...
        children: "use tokio::runtime::Runtime;\n\nfn main() {\n    // 创建多线程运行时\n    let rt = Runtime::new().unwrap();\n\n    rt.block_on(async {\n        println!(\"Hello from Tokio!\");\n    });\n}\n\n// 使用宏简化\n#[tokio::main]\nasync fn main() {\n    println!(\"Hello from Tokio!\");\n}\n"
      })
    }), _jsx(_components.h3, {
      id: "单线程运行时",
      children: _jsx(_components.a, {
      ...
      children: _jsx(_components.code, {
        className: "language-rust",
        children: "async fn fetch_data() -> Result<String, reqwest::Error> {\n    let response = reqwest::get(\"https://api.example.com/data\").await?;\n    let text = response.text().await?;\n    Ok(text)\n}\n\n#[tokio::main]\nasync fn main() {\n    match fetch_data().await {\n        Ok(data) => println!(\"Data: {}\", data),\n        Err(e) => eprintln!(\"Error: {}\", e),\n    }\n}\n"
      })
    }), _jsx(_components.h3, {
      id: "async-块",
      children: _jsx(_components.a, {
    ...
    }), _jsx(FutureStateMachine, {}), _jsx(_components.h3, {
      id: "future-定义",
      children: _jsx(_components.a, {
        href: "#future-定义",
        children: "Future 定义"
      ...
      children: ["探索更多：", _jsx(_components.a, {
        href: "./runtime",
        children: "Runtime 架构"
      }), " | ", _jsx(_components.a, {
        href: "./scheduling",
