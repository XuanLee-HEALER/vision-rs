...
function _createMdxContent(props) {
  ...
  return _jsxs(LearnLayout, {
    children: [_jsx(_components.h1, {
      ...
      children: ["在 Rust 中，变量绑定默认是", _jsx(_components.strong, {
        children: "不可变的"
      ...
      children: ["默认情况下，变量是", _jsx(_components.strong, {
        children: "不可变的"
      }), "："]
    }), _jsx(_components.pre, {
      children: _jsx(_components.code, {
...
`
      ...
      children: ["常量使用 ", _jsx(_components.code, {
        children: "const"
      }), " 关键字声明，并且", _jsx(_components.strong, {
        children: "必须"
      }), "标注类型："]
    }), _jsx(_components.pre, {
      children: _jsx(_components.code, {
        className: "language-rust",
        children: "const MAX_POINTS: u32 = 100_000;\nconst PI: f64 = 3.14159;\n\nfn main() {\n    println!(\"最大点数: {}\", MAX_POINTS);\n}\n"
      })
    }), _jsx(_components.h3, {
      id: "常量的特点",
      children: _jsx(_components.a, {
      ...
      children: [_jsx(_components.thead, {
        ...
        children: [_jsxs(_components.tr, {
          ...
          children: [_jsx(_components.td, {
            ...
            children: ["可以是", _jsx(_components.strong, {
              children: "全局"
            })]
          }), _jsx(_components.td, {
            children: "通常是局部"
          ...
          children: [_jsx(_components.td, {
            ...
            children: ["只能是", _jsx(_components.strong, {
              children: "常量表达式"
            })]
          }), _jsx(_components.td, {
            children: "任意表达式"
      ...
      children: ["\n", _jsxs(_components.li, {
        children: ["✅ Rust 中的变量默认", _jsx(_components.strong, {
          children: "不可变"
        })]
      }), "\n", _jsxs(_components.li, {
        children: ["✅ 使用 ", _jsx(_components.code, {
          children: "mut"
        }), " 关键字声明", _jsx(_components.strong, {
          children: "可变变量"
        })]
      }), "\n", _jsxs(_components.li, {
        children: ["✅ ", _jsx(_components.strong, {
        ...
        children: ["✅ ", _jsx(_components.strong, {
          children: "常量"
        }), "用 ", _jsx(_components.code, {
          children: "const"
        }), " 声明，必须标注类型，编译时求值"]
      }), "\n", _jsxs(_components.li, {
        children: ["✅ 不可变性带来", _jsx(_components.strong, {
          children: "安全性"
      ...
      children: ["下一步，我们将学习 Rust 的", _jsx(_components.strong, {
        children: "数据类型系统"
      }), "。"]
    })]
  });
