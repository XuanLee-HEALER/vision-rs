  ...
  return _jsxs(LearnLayout, {
    children: [_jsx(_components.h1, {
      ...
      children: [_jsx(_components.strong, {
        children: "借用"
      }), "（Borrowing）是 Rust 中在", _jsx(_components.strong, {
        children: "不获取所有权"
      }), "的情况下访问数据的机制。"]
    }), _jsx(_components.h2, {
      id: "引用",
      ...
      children: [_jsx(_components.code, {
        children: "&s1"
      }), " 创建一个", _jsx(_components.strong, {
        children: "指向"
      }), " ", _jsx(_components.code, {
        children: "s1"
      }), " 的引用，但", _jsx(_components.strong, {
        children: "不拥有"
      }), "它。"]
    }), _jsx(Mermaid, {
      chart: `
...
`
      ...
      children: ["默认情况下，引用是", _jsx(_components.strong, {
        children: "不可变的"
      }), "："]
    }), _jsx(_components.pre, {
      children: _jsx(_components.code, {
    ...
    }), _jsx(BorrowChecker, {}), _jsx(_components.h2, {
      id: "引用的作用域",
      children: _jsx(_components.a, {
        href: "#引用的作用域",
        children: "引用的作用域"
      ...
      children: ["引用的作用域从声明开始，持续到", _jsx(_components.strong, {
        children: "最后一次使用"
      }), "："]
    }), _jsx(_components.pre, {
      children: _jsx(_components.code, {
      ...
      children: ["这个特性叫做", _jsx(_components.strong, {
        children: "非词法作用域生命周期"
      ...
      children: ["Rust 编译器保证引用", _jsx(_components.strong, {
        children: "永远不会"
...
`
      ...
      children: ["\n", _jsxs(_components.li, {
        children: ["在任意给定时间，", _jsx(_components.strong, {
          children: "要么"
        }), "只能有一个可变引用，", _jsx(_components.strong, {
          children: "要么"
        }), "只能有多个不可变引用"]
      }), "\n", _jsxs(_components.li, {
        children: ["引用必须", _jsx(_components.strong, {
          children: "总是有效的"
        }), "（不能悬垂）"]
      }), "\n", _jsx(_components.li, {
      ...
      children: ["切片是一种", _jsx(_components.strong, {
        children: "特殊的引用"
      }), "，引用集合的连续序列："]
    }), _jsx(_components.pre, {
      children: _jsx(_components.code, {
      ...
      children: _jsx(_components.code, {
        className: "language-rust",
        children: "fn append_exclamation(s: &mut String) {\n    s.push('!');\n}\n\nfn main() {\n    let mut greeting = String::from(\"Hello\");\n    append_exclamation(&mut greeting);\n    println!(\"{}\", greeting);  // \"Hello!\"\n}\n"
      })
    }), _jsx(_components.h2, {
      id: "引用的内存表示",
      children: _jsx(_components.a, {
      ...
      children: [_jsx(_components.thead, {
        children: _jsxs(_components.tr, {
          children: [_jsx(_components.th, {
            ...
            children: ["引用 ", _jsx(_components.code, {
              children: "&T"
            })]
          }), _jsxs(_components.th, {
            children: ["智能指针 ", _jsx(_components.code, {
              children: "Box<T>"
            })]
          })]
        })
      ...
      children: _jsx(_components.code, {
        className: "language-rust",
        children: "fn reverse_string(s: &mut String) {\n    // 实现反转\n}\n\nfn main() {\n    let mut s = String::from(\"hello\");\n    reverse_string(&mut s);\n    println!(\"{}\", s);  // \"olleh\"\n}\n"
      })
    }), _jsxs("details", {
      children: [_jsx("summary", {
        children: "查看答案"
      ...
      children: ["\n", _jsxs(_components.li, {
        ...
        children: ["✅ ", _jsx(_components.code, {
          children: "&T"
        }), " 是不可变引用，", _jsx(_components.code, {
          children: "&mut T"
        }), " 是可变引用"]
      }), "\n", _jsxs(_components.li, {
        children: ["✅ 同一时间只能有", _jsx(_components.strong, {
          children: "一个可变引用"
