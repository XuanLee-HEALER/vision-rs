...
function _createMdxContent(props) {
  ...
  return _jsxs(_Fragment, {
    children: [_jsx(_components.h1, {
      ...
      children: "Rust 生态的强项在于：许多核心能力并不强行塞进标准库，而是通过高质量第三方库先行探索，再由实践反哺语言与工具链。理解这些库的设计理念与实现机制，能帮助你在架构层面做出正确选型，并避免\"只会用，不会解释\"的黑箱状态。"
    }), "\n", _jsx(_components.p, {
      ...
      children: "这部分的目标不是列清单，而是梳理\"生态为何这样形成、库为何这样分层、这些选择对项目意味着什么\"。"
      ...
      children: "感谢 Tokio 与 Serde 等核心库维护者持续投入，也感谢 Rust 社区对异步模型、宏与类型系统边界的长期打磨与讨论。"
    })]
  });
}
